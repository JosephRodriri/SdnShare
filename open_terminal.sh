...
# Panel 0: Monitor
tmux send-keys -t ddos_lab:0 'cd ~/Desktop/SdnShare&& ./scripts/ddos_monitor.sh' C-m

# Panel 1: Mininet
tmux split-window -v -t ddos_lab:0
tmux send-keys -t ddos_lab:0.1 'cd ~/Desktop/SdnShare && docker compose exec -it mininet ./scripts/mn_spineleaf_topo.py scripts/network_config.yaml' C-m
